...
"""
FastAPI application for the PlantGuard-Meta Environment.

This module creates an HTTP server that exposes the PlantGovernorEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m plant_governor_env.server.app
    ...
    multiple workers:
        uvicorn plant_governor_env.server.app:app --workers 4
    """
    import uvicorn
